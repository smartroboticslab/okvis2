...
%dataset = '/home/sleutene/datasets/euroc/V2_01_easy';
%dataset = '/home/sleutene/datasets/euroc/MH_01_easy';
dataset = '/home/sleutene/datasets/euroc/MH_05_difficult';
%dataset = '/home/sleutene/datasets/euroc/V1_03_difficult';
gt_file = [dataset '/state_groundtruth_estimate0/data.csv'];
%okvis_file = [dataset '/okvis2_final_trajectory.csv'];
okvis_file = [dataset '/okvis2_trajectory.csv'];
%okvis_file = [dataset '/okvis_trajectory.csv'];
